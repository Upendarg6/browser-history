...
class SearchItem extends Component{
    ...
    render(){
        ...
        return(
            ...
            <img src="https://assets.ccbp.in/frontend/react-js/history-website-logo-img.png]" alt="app logo" className=""/>
<div className="search-icon">
<img src="https://assets.ccbp.in/frontend/react-js/search-img.png" alt="search" className="sea"/>
<input type="search" className="inp" value={val} onChange={this.setVal}/>
</div>
            </div>
            <div>
